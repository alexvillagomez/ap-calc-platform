...
export async function GET() {
  ...
  const { data, error } = await supabase
    .from("rag_examples")
    .select("id, latex_content, solution_latex, choices, correct_index, difficulty, keyword_weights, action_weights, representation_weights, prerequisite_weights, avg_rating, rating_count, report_count, created_at, course")
    .not("choices", "is", null)
